...
const whitelistGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "ROLE GARDIEN (BENDO)",
        price: 100,
        hook: "Deviens gardien et impose ton autorite sur la prison virtuelle.",
        commands: [
          { name: "TO clic droit", desc: "timeout rapide sur cible" },
          { name: "mute clic droit", desc: "mute immediat en un clic" },
          { name: "+tempmute", desc: "mute temporaire personnalise" },
          { name: "acces tickets ban/bl", desc: "gestion des tickets sanctions" },
          { name: "gerer les messages", desc: "moderer les discussions" },
          { name: "gerer les pseudos", desc: "renommer et gerer les pseudos" },
        ],
        note: "Perm orientee moderation severe, a utiliser avec controle.",
      },
      {
        name: "SYS GESTION",
        price: 200,
